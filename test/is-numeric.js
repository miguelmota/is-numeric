...
test('isNumeric', function (t) {
  ...
  t.equal(isNumeric('1e10', {trim: false}), true)
  t.equal(isNumeric('100', {trim: false}), true)
  t.equal(isNumeric('1e10', {trim: true}), true)
  t.equal(isNumeric('100', {trim: true}), true)
  t.equal(isNumeric('  -3', {trim: true}), true)
})
